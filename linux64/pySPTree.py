...
class MCFClass(_object):
    ...
    pSn = 0, pEn = 0): return _pySPTree.MCFClass_LoadNet(self, nmx, mmx, pn, pm, pU, pC, pDfct, pSn, pEn)
...
class SPTree(MCFClass):
    ...
    def LoadNet(self, nmx = 0, mmx = 0, pn = 0, pm = 0, pU = 0, pC = 0, pDfct = 0, 
    pSn = 0, pEn = 0): return _pySPTree.SPTree_LoadNet(self, nmx, mmx, pn, pm, pU, pC, pDfct, pSn, pEn)
